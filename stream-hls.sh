...
ESP32_CAM_URL="http://192.168.1.95:81"
...
ffmpeg -listen 2 -i $ESP32_CAM_URL -c:v h264_videotoolbox -b:v $VIDEO_BITRATE -f hls -hls_list_size 5 -hls_time $HLS_TIME -hls_playlist_type event $OUTPUT_DIRECTORY/stream.m3u8
